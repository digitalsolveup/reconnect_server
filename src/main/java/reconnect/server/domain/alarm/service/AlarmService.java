package reconnect.server.domain.alarm.service;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Service;
import org.springframework.web.servlet.mvc.method.annotation.SseEmitter;
import reconnect.server.domain.alarm.mapper.AlarmInfoMapper;
import reconnect.server.domain.alarm.model.request.AlarmRequest;
import reconnect.server.domain.alarm.model.request.AlarmUrlResponse;
import reconnect.server.domain.alarm.model.response.AlarmResponse;
import reconnect.server.domain.alarm.model.vo.UserAlarmInfo;
import reconnect.server.domain.alarm.repository.AlarmRepository;
import reconnect.server.domain.alarm.repository.EmitterRepository;
